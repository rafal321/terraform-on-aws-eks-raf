...
#   # }
# #     tags = {
# #     Name = "MyProduct-anton"
# #   }
# }
# # ----------------------
# # we need to create mount target in each subnet
...
#   security_groups = [aws_eks_cluster.eks.vpc_config[0].cluster_security_group_id]
#   # this SG vas created by EKS itself
# }
# # now all eks workers can connect to filesystem

# # ------------------------------------------------------------------
# # add all premissions for efs csi driver to attach volumes to worker nodes
# # because we use openID provider we need to create trust policy
...
# }
# # ----------------------
# # we create custom kubernetes storage class that uses efs file system
